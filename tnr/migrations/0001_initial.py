    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_city', models.CharField(blank=True, default='Los Angeles', max_length=50, verbose_name='What is your home city?')),
                ...
                ('colony_city', models.CharField(blank=True, default='Los Angeles', max_length=50, verbose_name='What city is the colony located?')),
                ...
                ('cats_feeding', models.CharField(blank=True, max_length=200, verbose_name='Who feeds the cats? What time are they normall fed (morning/evening)?')),
                ('scheduling_issues', models.CharField(blank=True, max_length=200, verbose_name='The community partner needs to be present to show us where the cats hang out. Any scheduling issues which might cause issues?')),
                ...
                ('app_status', models.TextField(blank=True, verbose_name='Application Status')),
            ],
        ),
        migrations.CreateModel(
            name='TNREvent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes_private', models.TextField(blank=True, verbose_name='Public Notes')),
                ('notes_public', models.TextField(blank=True, verbose_name='Private Notes. (Not to be shared with CP.)')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tnr.TNREvent')),
            ],
        ),
        migrations.CreateModel(
            name='TNRRole',
